"""Additive email export. V1 exporter remains available unchanged for auditability."""
...
def main() -> None:
    ...
    for name, model in MODELS:
        ...
        catalog["contracts"].append(
            dict(name=name, version="1", filename=filename, schema_digest=canonical_digest(schema))
        )
